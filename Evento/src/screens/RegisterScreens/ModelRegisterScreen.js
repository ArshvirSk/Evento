    ...
    <ScrollView>
      ...
      <View style={styles.container}>
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <InputField
              name="Participant 3 Phone Number"
              onBlur={onBlur}
              onChange={onChange}
              value={value}
            />
        ...
        />
        {errors.participant3phonenumber && (
          <Text style={{ color: 'red', marginTop: -15, marginBottom: 10 }}>
            This is required.
          </Text>
        )}
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <InputField
              name="Participant 4 Phone Number"
              onBlur={onBlur}
              onChange={onChange}
              value={value}
            />
        ...
        />
        {errors.participant4phonenumber && (
          <Text style={{ color: 'red', marginTop: -15, marginBottom: 10 }}>
            This is required.
          </Text>
        )}
...
export default ModelRegisterScreen;
